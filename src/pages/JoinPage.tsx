...
export default function JoinPage() {
    ...
    const howPoints = [
        ...
        {
            action: "Réaliser 10 publications dans le mois",
            points: 30,
            bonus: true,
        },
        {
            action: "Maintenir le niveau Or 3 mois consécutifs",
            points: 100,
            bonus: true,
        },
    ];
        ...
        <div>
            ...
            >
                <div
                    ...
                    style={{
                        backgroundImage:
                            "radial-gradient(circle at 20% 80%,#00A651 0%,transparent 40%),radial-gradient(circle at 80% 20%,#FF6B00 0%,transparent 40%)",
                    }}
                />
                ...
                <div className="container">
                    <div className="text-center mb-14">
                        ...
                        <h2 className="section-title mb-4">
                            Pourquoi devenir relais ?
                        </h2>
                        <p className="section-subtitle max-w-xl mx-auto">
                            Des avantages concrets, un système transparent, des
                            paiements fiables.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Gagnez entre 2 000 et 25 000+ FCFA par mois selon votre niveau et activité.",
                                color: "#00A651",
                            },
                            {
                                icon: "📱",
                                title: "Travail depuis mobile",
                                desc: "Tout se fait depuis votre smartphone Android. Aucun équipement spécial requis.",
                                color: "#1E3A8A",
                            },
                            {
                                icon: "⏰",
                                title: "Horaires libres",
                                desc: "Publiez quand vous voulez. Vous gérez votre temps comme vous l'entendez.",
                                color: "#FF6B00",
                            },
                            {
                                icon: "📊",
                                title: "Tableau de bord",
                                desc: "Suivez vos points en temps réel dans votre espace relais. Transparence totale.",
                                color: "#8b5cf6",
                            },
                            {
                                icon: "🎓",
                                title: "Formations offertes",
                                desc: "Accédez à des formations sur les réseaux sociaux et le marketing digital.",
                                color: "#00A651",
                            },
                            {
                                icon: "🤝",
                                title: "Communauté",
                                desc: "Rejoignez le groupe WhatsApp AYIHA BUILDERS et échangez avec tous les relais.",
                                color: "#1E3A8A",
                            },
                        ].map((item) => (
                            <div
            ...
            <section className="py-20" style={{ background: t.sectionWht }}>
                <div className="container">
                    <div className="text-center mb-14">
                        ...
                        <p className="section-subtitle max-w-xl mx-auto">
                            Chaque action de publication vous rapporte des
                            points. Plus vous êtes actif, plus vous gagnez.
                        </p>
                    </div>
                    <div className="container max-w-2xl mx-auto space-y-3 mb-12">
                        {howPoints.map((item) => (
                            <div
                                key={item.action}
                            ...
                            >
                                ...
                                <div
                                    className="font-poppins font-black text-lg flex-shrink-0 ml-4"
                                    style={{
                                        color: item.bonus
                                            ? "#FF6B00"
                                            : "#00A651",
                    ...
                    <div
                        className="container p-5 rounded-2xl text-sm"
                        style={{
                            maxWidth: "720px",
                            background: dark
                                ? "rgba(30,58,138,0.1)"
                                : "rgba(30,58,138,0.05)",
                            border: `2px solid ${dark ? "rgba(30,58,138,0.2)" : "rgba(30,58,138,0.1)"}`,
                            color: t.textMuted,
                            lineHeight: 1.7,
                        }}
                    >
                        ...
                        Les points sont comptabilisés uniquement après
                        vérification et validation de vos screenshots. Tout
                        screenshot non conforme ou dupliqué sera rejeté
                        automatiquement.
                    </div>
                </div>
            </section>
            ...
            <section className="py-20" style={{ background: t.sectionAlt }}>
                <div className="container">
                    <div className="text-center mb-14">
                        ...
                        <h2 className="section-title mb-4">
                            Progressez dans la hiérarchie
                        </h2>
                        <p className="section-subtitle max-w-xl mx-auto">
                            4 niveaux avec des avantages croissants. Plus vous
                            progressez, plus vous gagnez.
                        </p>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        {levels.map((level, i) => (
                            ...
                            >
                                ...
                                <div
                                    className="py-3 px-4 rounded-xl text-center mb-5 font-poppins font-bold text-base"
                                    style={{
            ...
            <section id="etapes" className="py-20" style={{ background: t.sectionWht }}>
                <div className="container">
                    <div className="text-center mb-14">
                        ...
                        <p className="section-subtitle max-w-xl mx-auto">
                            En moins de 48h, vous pouvez commencer à gagner des
                            points et des revenus.
                        </p>
                    </div>
            ...
            >
                <div
                    ...
                    style={{
                        backgroundImage:
                            "radial-gradient(circle at 30% 50%,#00A651 0%,transparent 50%)",
                    }}
                />
                <div className="relative z-10 container">
                    ...
                    >
                        Remplissez notre formulaire ou contactez-nous
                        directement sur WhatsApp. Notre équipe vous répondra
                        dans les 24 heures.
                    </p>
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <button
                    ...
                    >
                        ✓ Gratuit · ✓ Sans engagement · ✓ Paiements MoMo
                        garantis
                    </p>
                </div>
            </section>
