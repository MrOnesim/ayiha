...
export default function OffersPage() {
    ...
    const plans = [
        {
            ...
            color: "#6b7280",
            lightBg: dark ? "rgba(107,114,128,0.08)" : "#f9fafb",
            icon: Zap,
            featured: false,
        ...
        },
        {
            ...
            price: "35 000",
            period: "FCFA / mois",
            tagline: "Le choix des entrepreneurs",
            color: "#00A651",
            lightBg: dark ? "rgba(0,166,81,0.1)" : "#f0fdf4",
            icon: TrendingUp,
            featured: true,
        ...
        },
        {
            ...
            price: "75 000",
            period: "FCFA / mois",
            tagline: "Visibilité nationale maximale",
            color: "#FF6B00",
            lightBg: dark ? "rgba(255,107,0,0.08)" : "#fff7ed",
            icon: Star,
            featured: false,
    ...
    const faqs = [
        {
            q: "Comment fonctionne le système de publication ?",
            a: "Vous nous envoyez votre contenu (image + texte). Nos relais publient sur WhatsApp, Facebook, Instagram et envoient des screenshots horodatés comme preuves.",
        },
        {
            q: "Quand sont effectués les paiements aux relais ?",
            a: "Les paiements MoMo sont effectués en fin de mois, entre le 28 et le 31. Chaque relais reçoit son bilan détaillant ses points et son gain exact.",
        },
        {
            q: "Puis-je changer de formule en cours de mois ?",
            a: "Oui ! Vous pouvez upgrader votre formule à tout moment. La différence est calculée au prorata. Contactez-nous sur WhatsApp.",
        },
        {
            q: "Quelle est la différence entre relais et client ?",
            a: "Les clients paient pour que leur contenu soit diffusé. Les relais publient ce contenu et gagnent des points. Vous pouvez être les deux !",
        },
        {
            q: "Comment rejoindre le réseau en tant que relais ?",
            a: 'Remplissez le formulaire sur la page "Rejoindre" ou contactez-nous sur WhatsApp. Après vérification, vous recevez vos accès.',
        },
        {
            q: "Y a-t-il un engagement de durée ?",
            a: "Non ! Nos formules sont sans engagement. Vous pouvez arrêter à tout moment.",
        },
    ];
        ...
        <div>
            ...
            >
                <div className="container">
                    ...
                    >
                        Choisissez la formule qui correspond à votre budget et
                        vos objectifs. Tous les plans incluent des preuves
                        screenshots vérifiables.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20" style={{ background: t.sectionAlt }}>
                <div className="container">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div
                                            className="font-poppins font-black text-xl mb-1"
                                    ...
                                    <div className="text-center mb-6">
                                        <span
                                            className="font-poppins font-black text-5xl"
                                            style={{
                                                color: t.textPrim,
                                                lineHeight: 1,
                                            }}
                    ...
                    <div
                        ...
                        style={{ color: t.textFaint }}
                    >
                        💳 Paiement par MoMo · 📞 Support WhatsApp · 🔒 Aucun
                        engagement
                    </div>
                </div>
            </section>
                ...
                <div className="container">
                    <div className="text-center mb-14">
                        ...
                        <p className="section-subtitle">
                            Tous nos plans partagent ces garanties
                            fondamentales.
                        </p>
                    </div>
                        ...
                        {[
                            {
                                ...
                                desc: "Screenshots horodatés de chaque publication. Transparence totale et traçabilité garantie.",
                                color: "#1E3A8A",
                            },
                            {
                                icon: Users,
                                title: "Relais certifiés",
                                desc: "Tous nos relais sont vérifiés, formés et motivés. Qualité de diffusion assurée.",
                                color: "#00A651",
                            },
                            {
                                icon: BarChart2,
                                title: "Rapport mensuel",
                                desc: "Bilan complet de vos performances : portée, publications, preuves, statistiques.",
                                color: "#FF6B00",
                            },
                            {
                                icon: Phone,
                                title: "Support WhatsApp",
                                desc: "Notre équipe répond à vos questions rapidement. Pas de ticket, contact direct.",
                                color: "#25D366",
                            },
                            {
                                icon: Clock,
                                title: "Publication rapide",
                                desc: "Votre contenu est diffusé dans les 24h après validation. Efficacité maximale.",
                                color: "#8b5cf6",
                            },
                            {
                                icon: Zap,
                ...
                <div className="container">
                    ...
                    <div className="space-y-4">
                        {faqs.map((faq) => (
                            ...
                            >
                                <summary
                                    className="flex items-center justify-between p-5 cursor-pointer font-semibold text-base"
                                    style={{ color: t.navy, listStyle: "none" }}
                                >
                                    {faq.q}
                                    <span
            ...
            >
                <div className="container">
                    ...
                    >
                        Choisissez votre formule et contactez-nous sur WhatsApp
